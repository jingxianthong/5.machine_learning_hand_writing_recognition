...
from views import PredictDigitView, IndexView, NumberIdentificationView  # Make sure to import your new view
...
app.add_url_rule(
    ...
    view_func=NumberIdentificationView.as_view('number_identification'),
    methods=['GET']
)
